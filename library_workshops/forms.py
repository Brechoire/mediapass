...
class WorkshopForm(forms.ModelForm):
    ...
    age_range_display = forms.CharField(
        ...
        label="Tranche d'âge sélectionnée"
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            'poster', 'is_all_ages', 'min_age', 'max_age',
            'newsletter', 'is_class_welcome'
        ]
        widgets = {
            ...
            'is_all_ages': forms.CheckboxInput(attrs={
            ...
            'is_class_welcome': forms.CheckboxInput(attrs={
                'class': 'w-4 h-4 rounded border-gray-300 text-[#4a6fa5] focus:ring-[#4a6fa5]'
            })
        }
...
class WorkshopGroupReservationForm(forms.Form):
    ...
    def clean_group_size(self):
        ...
        if group_size > 10:
            raise forms.ValidationError(
                "Un groupe ne peut pas dépasser 10 personnes."
            )
        return group_size

...
class Workshop(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['start_date', 'start_time'], name='idx_workshop_start'),
        ]
    ...
    def confirmed_participants(self):
        ...
        if hasattr(self, '_confirmed_prefetched') and hasattr(self, 'confirmed_participants_list'):
    ...
    def waiting_participants(self):
        ...
        if hasattr(self, '_waiting_prefetched') and hasattr(self, 'waiting_participants_list'):
    ...
    def clean(self):
        ...
        if not self.is_all_ages:
            ...
            if (self.min_age is not None and self.max_age is not None and
...
class WorkshopParticipant(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['workshop', 'status'], name='idx_participant_ws_status'),
        ]
